...
$cfg['blowfish_secret']					= 'Hvn<v%FKO_b;z6\'Q|TIiQ#l<V2O\'3z2]' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
$cfg['DefaultLang']						= 'en';		// 'en'
$cfg['Servers'][$i]['only_db']			= array('Pelostop') ;    //i.e. array('db1', 'db2') Show only listed databases
